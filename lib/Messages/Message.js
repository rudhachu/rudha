const { decodeJid, parsedJid } = require("../functions");
...
class Message extends Base {
    ...
    const quot = {
      ...
      message: {
        newsletterAdminInviteMessage: {
          ...
          jpegThumbnail: `https://raw.githubusercontent.com/rudhra-prh/media/main/image/rudhra3.jpeg`,
          caption: `ʀᴜᴅʜʀᴀ ʙᴏᴛ\n${this.text}`,
  ...
  async sendMessage(
    jid,
    content,
    opt = { packname: "Ʀ ᴜ ᴅ ʜ ʀ λ", author: "Ƥ ʀ ɪ ɴ ᴄ ᴇ  Ʀ ᴜ ᴅ ʜ", fileName: "ʀᴜᴅʜʀᴀ ʙᴏᴛ" },
    type = "text"
  ) {
